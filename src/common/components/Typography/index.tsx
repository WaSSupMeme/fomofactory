...
export const typographyVariants = cva('text-foreground', {
  variants: {
    ...
    variant: {
      h1: 'scroll-m-20 text-center text-5xl font-extrabold tracking-tight',
      h2: 'scroll-m-20 text-center text-4xl font-semibold tracking-tight',
      h3: 'scroll-m-20 text-center text-3xl font-semibold tracking-tight',
      h4: 'scroll-m-20 text-center text-2xl font-semibold tracking-tight',
      h5: 'scroll-m-20 text-center text-xl font-semibold tracking-tight',
      h6: 'scroll-m-20 text-center text-lg font-semibold tracking-tight',
...
const variantElementMap = {
  ...
  mutedText: 'p',
  ul: 'ul',
} as const satisfies Record<NonNullable<VariantProps<typeof typographyVariants>['variant']>, string>
